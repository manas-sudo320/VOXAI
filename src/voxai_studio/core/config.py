...
DEFAULT_SCHEMA: dict[str, ConfigSchemaEntry] = {
    ...
    "logging.directory": ConfigSchemaEntry(str, allow_empty=False),
    "logging.file_name": ConfigSchemaEntry(str, allow_empty=False),
    "logging.format": ConfigSchemaEntry(str, allow_empty=False),
    "logging.date_format": ConfigSchemaEntry(str, allow_empty=False),
    "logging.console_enabled": ConfigSchemaEntry(bool),
    "logging.file_enabled": ConfigSchemaEntry(bool),
    "logging.max_bytes": ConfigSchemaEntry(int, minimum=1024),
    "logging.backup_count": ConfigSchemaEntry(int, minimum=0),
